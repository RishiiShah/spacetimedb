...
1. **Work in this repository** — create, edit, and delete files here.
2. **Git commands run here** — run all git commands from this folder.
3. **Runtime assets** — live under `public/assets/`. Paths are defined in `src/game/assets.ts`.
4. **Use project skills** — load guidance from `.cursor/skills/`. Start with `.cursor/skills/spacetimedb/SKILL.md` for SpacetimeDB work.
5. **Project docs** — architecture, schema, deployment, and plans live in `docs/`.
